...
if  [[ $1 = "-amber" ]]; then
# Replacing colors
sed -i -e 's/bg = .*/bg = #FFFFFF/g' $PDIR/config2.ini
sed -i -e 's/fg = .*/fg = #000000/g' $PDIR/config2.ini
sed -i -e 's/fg-alt = .*/fg-alt = #424242/g' $PDIR/config2.ini
...
sed -i -e 's/fg = .*/fg = #000000/g' $PDIR/config.ini
