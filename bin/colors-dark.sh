...
if  [[ $1 = "-amber" ]]; then
# Replacing colors
sed -i -e 's/bg = .*/bg = #000000/g' $PDIR/config2.ini
sed -i -e 's/fg = .*/fg = #aaaaaa/g' $PDIR/config2.ini
sed -i -e 's/fg-alt = .*/fg-alt = #A9ABB0/g' $PDIR/config2.ini
sed -i -e 's/acolor = .*/acolor = #ffb300/g' $PDIR/config2.ini
...
sed -i -e 's/fg = .*/fg = #aaaaaa/g' $PDIR/config.ini
