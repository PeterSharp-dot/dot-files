...
local mic_toggle = "pactl set-source-mute @DEFAULT_SOURCE@ toggle"
-- local dark_terminal = "termite" .. " -c /home/peter/.config/termite/config_black"
local dark_terminal = "termite"
...
local lighter = "brightnessctl set +5%"
local darker = "brightnessctl set 5%-"
...
awful.screen.connect_for_each_screen(function(s)
	...
	myweatherwidget, weather_timer =
		awful.widget.watch('curl wttr.in/51.2204629,22.6998639?format="%c+%p+%t+%w+%P"', 240)
	...
	local mysystray = wibox.widget.systray({ forced_width = 40 })
	...
	local battery_widget = wibox.widget({
		{
			...
			image = "/hoome/peter/.config/awesome/wombat-2/battery/battery-full.png",
		},
		{
			id = "percentage",
	...
	local function update_battery(widget, args)
		local percentage = args[2]
		widget:get_children_by_id("percentage")[1]:set_text("" .. percentage .. "%  ")

		local icon_widget = widget:get_children_by_id("icon")[1]

		if percentage >= 80 then
			icon_widget.image = "/home/peter/.config/awesome/wombat-2/battery/battery-full.png"
		elseif percentage >= 60 then
			icon_widget.image = "/home/peter/.config/awesome/wombat-2/battery/battery-good.png"
		elseif percentage >= 40 then
			icon_widget.image = "/home/peter/.config/awesome/wombat-2/battery/battery-medium.png"
		elseif percentage >= 20 then
			icon_widget.image = "/home/peter/.config/awesome/wombat-2/battery/battery-low.png"
		elseif percentage >= 10 then
			icon_widget.image = "/home/peter/.config/awesome/wombat-2/battery/battery-caution.png"
		else
			icon_widget.image = "/home/peter/.config/awesome/wombat-2/battery/battery-critical.png"
		end
	end

	-- Register widget with Vicious
	vicious.register(battery_widget, vicious.widgets.bat, update_battery, 61, "BAT0")

	-- Add widget to wibox (assuming you have a wibox called mywibox)

	-- LOGO
	local logo_widget = wibox.widget.textbox("   ")
...
globalkeys = gears.table.join(
	...
	awful.key({}, "XF86AudioMicMute", function()
		awful.spawn(mic_toggle)
		volume_timer:emit_signal("timeout")
	end, { description = "mute_microfon", group = "control" }),

	awful.key({}, "XF86MonBrightnessDown", function()
		awful.spawn(darker)
		volume_timer:emit_signal("timeout")
	end, { description = "darker", group = "control" }),
	awful.key({}, "XF86MonBrightnessUp", function()
		awful.spawn(lighter)
		volume_timer:emit_signal("timeout")
	end, { description = "lighter", group = "control" }),
