...
static uint32_t colors[][3] = {
    /*               fg          bg          border    */
    [SchemeNorm] = {0xbbbbbbff, 0x222222ff, 0x222222ff},
...
static const Rule rules[] = {
    ...
    {"zen-beta", NULL, 1 << 8, 0, -1}, /* Start on ONLY tag "9" */
};
...
static const char *volumeup[] = {"volup.sh", NULL};
static const char *volumedown[] = {"voldown.sh", NULL};
static const char *volumemute[] = {"volmute.sh", NULL};
static const char *suspend[] = {"sleep.sh", NULL};
static const char *watch[] = {"open-meteo-notify.sh", NULL};
static const char *screenshot[] = {"scro.sh", NULL};
static const char *close_notification[] = {"close_dunst_notification.sh", NULL};
static const char *launcher[] = {
    "kitty", "--", "bash", "-c", "~/.local/bin/fzf_launcher.sh; exit", NULL};

static const Key keys[] = {
    /* Note that Shift changes certain key codes: c -> C, 2 -> at, etc. */
    /* modifier                  key                 function        argument */
    {MODKEY, XKB_KEY_p, spawn, {.v = menucmd}},
    {MODKEY, XKB_KEY_r, spawn, {.v = launcher}},
    {MODKEY, XKB_KEY_F2, spawn, {.v = volumeup}},
    {MODKEY, XKB_KEY_F1, spawn, {.v = volumedown}},
    {MODKEY, XKB_KEY_F3, spawn, {.v = volumemute}},
    {MODKEY | WLR_MODIFIER_CTRL, XKB_KEY_d, spawn, {.v = suspend}},
    {MODKEY, XKB_KEY_z, spawn, {.v = watch}},
    {MODKEY, XKB_KEY_Print, spawn, {.v = screenshot}},
    {MODKEY | WLR_MODIFIER_CTRL, XKB_KEY_c, spawn, {.v = close_notification}},
