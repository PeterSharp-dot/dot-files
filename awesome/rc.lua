...
local hotkeys_popup_jo_sized = hotkeys_popup_jo.widget.new({ width = 1800, height = 1200, font = "Source Code Pro Bold 14", description_font = "Mono 12"});
...
local browser = "/usr/lib64/firefox/firefox"
local activ_firefox = "/home/peter/.bin/lof /usr/lib64/firefox/firefox"
local activ_kitty = "/home/peter/.bin/lof /usr/bin/kitty" 
local calendar = "firefox https://calendar.google.com/calendar/u/0/r?pli=1"
local mail = "firefox https://mail.google.com/mail/u/0/#inbox"
...
local virtualmachine    = "vijtualbox"
local black_theme = "/home/peter/.bin/black-theme-awesome.sh"
local dracula_theme = "/home/peter/.bin/dracula-theme-awesome.sh"
local white_theme = "/home/peter/.bin/white-theme-awesome.sh"
local solarized_theme = "/home/peter/.bin/solarized-theme-awesome.sh"
local sleep = "/home/peter/.bin/sleep.sh"
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey,           }, "w", function () awful.spawn(activ_firefox) end,
              {description = "activate firefox", group = "programs"}),
    awful.key({modkey,            }, "a", function () awful.spawn(activ_kitty) end,
              {description = "activate terminal", group = "programs"}),
    -- dmenu
  awful.key({ modkey }, "p",
    function ()
        awful.spawn(string.format("dmenu_run -i -nb '#191919' -nf '#fea63c' -sb '#fea63c' -sf '#191919' -fn NotoMonoRegular:bold:pixelsize=16",
  ...
  awful.key({ modkey }, "d",
    ...
    awful.key({modkey,            }, "c", function () awful.util.spawn(calendar) end,
              {description = "show google calendar", group = "programs"}),
    --awful.key({modkey,            }, "e", function () awful.util.spawn(mail) end,
              --{description = "show gmail", group = "programs"}),
    ...
    awful.key({ modkey, "Shift" }, "e",  function () awful.util.spawn( "archlinux-logout" ) end,
      {description = "exit", group = "hotkeys"}),
  --awful.key({ modkey }, "Escape", function () awful.util.spawn( "xkill" ) end,
        --{description = "Kill proces", group = "hotkeys"}),
    awful.key({ modkey,           }, "Escape", awful.tag.history.restore,
              {description = "go back", group = "tag"}),
    awful.key({ modkey,           }, "End", function () awful.spawn.with_shell(sleep) end,
              {description = "suspend", group = "control"}),
    awful.key({         "Shift"   }, "End", function () awful.spawn.with_shell(sleep) end,
              {description = "suspend", group = "control"}),
    ...
    awful.key({ modkey,           }, "Return", function () 
      if client.focus == awful.client.getmaster()
      then 
        ...
        awful.client.setmaster(client.focus)
              ...
              {description = "swap with next client with master", group = "client"}),
    ...
    awful.key({ modkey, "Shift"   }, "w",
      function () awful.spawn(white_theme) end,
              {description = "open white theme", group = "themes"}),
    awful.key({ modkey, "Shift"   }, "b",
      function () awful.spawn(black_theme) end,
              {description = "open black theme", group = "themes"}),
    awful.key({ modkey, "Shift"   }, "d",
      function () awful.spawn(dracula_theme) end,
              {description = "open dracula theme", group = "themes"}),
    awful.key({ modkey, "Shift"   }, "s",
      function () awful.spawn(solarized_theme) end,
              {description = "open solarized theme", group = "themes"}),
    awful.key({ modkey, "Shift"   }, "x",
      function () awful.spawn(l_solarized_theme) end,
              {description = "open light solarized theme", group = "themes"}),
...
clientkeys = my_table.join(
    ...
    awful.key({modkey, "Shift"              }, "t", 
        function (c)   
          ...
          c.height = 920
          c.y = c.screen.geometry.height* 0.1
        end,
        {description = "precise floating window", group = "client"}),
    awful.key({modkey, "Shift"              }, "y", 
        ...
        {description = "terminal size window", group = "client"})
)
...
awful.spawn.with_shell("picom -b --config  $HOME/.config/awesome/picom2.conf")
