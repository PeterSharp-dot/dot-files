...
hi LineNr  ctermbg=NONE ctermfg=234  guibg=#f5f5f5 guifg=#808080 cterm=NONE gui=NONE
hi NonText ctermbg=NONE ctermfg=244  guibg=NONE    guifg=#808080 cterm=NONE gui=NONE
hi Title  ctermbg=NONE ctermfg=22   guibg=NONE    guifg=#000000 cterm=NONE  gui=bold
hi Folded ctermbg=15   ctermfg=235  guibg=NONE guifg=#5d759c cterm=NONE  gui=NONE
hi Function   ctermbg=NONE ctermfg=33   guibg=NONE guifg=#0087ff cterm=NONE gui=bold
